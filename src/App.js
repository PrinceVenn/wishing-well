...
var wisdoms = [
  ...
  "I'm finally doing something that could be seen as correct by a select few.",
  "I just need to keep working in my off time",
  "Can we add one more host? I don't know what that means."
]
